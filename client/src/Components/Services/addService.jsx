  ...
  return (
    <div>
      <Collapse bordered={false} defaultActiveKey='1'>
        ...
        <Panel style={{ fontWeight: 'bold' }} header='Owner Details ' key='2'>
          <Row gutter={24}>
            <Col span='10' offset='1'>
              <div style={{ marginBottom: '1rem' }}>
                <div style={{ paddingBottom: '0.5rem', fontWeight: 'bold' }}>
            ...
            <Col span='10' offset='1'>
              <div style={{ marginBottom: '1rem' }}>
                ...
                <Input
                  value={field.contact}
                  onChange={(e) => setFieldFn('contact', e.target.value)}
            ...
            <Col span='10' offset='1'>
              <div style={{ marginBottom: '1rem' }}>
                ...
                <Select
                  ...
                  style={{ width: '100%', fontWeight: 'normal' }}
                  value={field.gender}
                  onChange={(e) => setFieldFn('gender', e.target.value)}
                >
        ...
        <Panel style={{ fontWeight: 'bold' }} header='Address ' key='3'>
          <Row gutter={24}>
            <Col span='10' offset='1'>
              <div style={{ marginBottom: '1rem' }}>
                <div style={{ paddingBottom: '0.5rem', fontWeight: 'bold' }}>
            ...
            <Col span='10' offset='1'>
              <div style={{ marginBottom: '1rem' }}>
                ...
                <Input
                  ...
                  style={{ width: '100%', fontWeight: 'normal' }}
                  value={field.state}
                  onChange={(e) => setFieldFn('state', e.target.value)}
                />
              </div>
            </Col>
          </Row>
            ...
            <Col span='10' offset='1'>
              <div style={{ marginBottom: '1rem' }}>
                ...
                <Input
                  ...
                  style={{ width: '100%', fontWeight: 'normal' }}
                  value={field.city}
                  onChange={(e) => setFieldFn('city', e.target.value)}
                />
              </div>
            </Col>
            <Col span='10' offset='1'>
